...
import ru.tinkoff.vorobev.exam.databinding.RecyclerItemBinding
import ru.tinkoff.vorobev.exam.viewmodel.PopularFilmsViewModel
import java.util.*

class PopularFilmsAdapter (private val viewModel: PopularFilmsViewModel):
    RecyclerView.Adapter<PopularFilmsAdapter.ItemViewHolder>(){
